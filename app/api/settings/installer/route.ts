...
`
  ...
  const configured = script
    ...
    .replace("[string] $NavDatabaseServer = 'localhost',",    `[string] $NavDatabaseServer = '${navDatabaseServer || tenant.navDatabaseServer || 'localhost'}',`)
    .replace("[string] $NavDatabaseName   = '',",             `[string] $NavDatabaseName   = '${navDatabaseName || tenant.navDatabaseName || ''}',`)
    .replace("[string] $NavServerInstance    = '',",         `[string] $NavServerInstance    = '${navServerInstance || tenant.navServerInstance || ''}',`)
    .replace("[string] $TestNavDatabaseServer = '',",         `[string] $TestNavDatabaseServer = '${testNavDatabaseServer || tenant.testNavDatabaseServer || ''}',`)
    .replace("[string] $TestNavDatabaseName   = '',",         `[string] $TestNavDatabaseName   = '${testNavDatabaseName || tenant.testNavDatabaseName || ''}',`)
