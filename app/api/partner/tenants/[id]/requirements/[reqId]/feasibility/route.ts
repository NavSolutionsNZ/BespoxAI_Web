...
// ── POST /api/partner/tenants/[id]/requirements/[reqId]/feasibility ─────────
...
${requirement.description}`
  ...
  try {
    ...
    logAiUsage({ tenantId: requirement.tenantId, requirementId: params.reqId, feature: 'feasibility', model: cfg.model, inputTokens, outputTokens })
