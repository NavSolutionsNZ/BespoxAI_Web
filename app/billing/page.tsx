      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 15, color: 'var(--slate)', margin: '0 0 28px' }}>
            All prices in NZD, plus GST (15%). GST is added at checkout. International customers pay in their local currency.
          </p>
            ...
            return (
              <div key={plan.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'flex-end', gap: 4, marginBottom: 4 }}>
                  ...
                  <div style={{ fontSize: 10, color: isPopular ? 'rgba(244,239,228,0.5)' : 'var(--slate)', marginBottom: 6, fontFamily: 'var(--font-mono)', letterSpacing: '0.04em' }}>plus GST</div>
                </div>
        ...
        <div style={{ background: 'var(--white)', border: '1px solid var(--fog)', borderRadius: 12, padding: '20px 24px', marginBottom: 32, maxWidth: 600, margin: '0 auto 32px' }}>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 9, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--forest)', marginBottom: 8 }}>Senior Developer Review — $249 NZD plus GST</p>
